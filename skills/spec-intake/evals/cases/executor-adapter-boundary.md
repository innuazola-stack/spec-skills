...
- Do not produce `prd.md`, `prd-brief.md`, legacy Human/Agent PRD files, HLD, task plans, task graphs, dependency edges, parallel groups, or implementation task cards in the Stage 1 package.
