...
- Include `planning_harness_model`, all four `phase_reports`, `task_logic_review.status=pass`, and `plan_integrity_review.status=pass`.
...
- Ready planning without the four harness-style stages.
